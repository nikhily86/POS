...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Sales Person') }}</div>
                ...
                <div class="card-body">
                    <form method="POST"  enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="form-group row d-flex justify-content-center">
                            <div class="mr-5">
                               <label for="gender" class="mr-5 ">{{ __('Gender ') }}</label>
                            </div>
                        ...
                        <div class="form-group row d-flex justify-content-center">
                        <label for="image" class="mr-4 ">{{ __('Picture ') }}</label>
                          <input type="file" class="" name="file" placeholder="Choose file" id="file">
                        </div>
