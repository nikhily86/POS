...
<div class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-4">
         ...
         <!-- ADD PRODUCTS FOR BILLING STARTS-->
         ...
         <table class="table table-striped">
            ...
            <tbody>
               <tr>
                 ...
                 <!-- SHOWING ALL PRODUCTS FROM DATABASE TO DROPDOWN -->
         ...
         <!-- ADD PRODUCTS FOR BILLING ENDS-->

         <!-- CHECK ALL ORDERS STARTS -->

         <div class="text-center ">
            <a href="/checkOrder" class="btn btn-warning">Check Orders</a>
         </div>

         <!-- CHECK ALL ORDERS ENDS -->
      </div>
...
<script>
   ...
   // AJAX CALL FOR GETTING PRICE OF SELECTED PRODUCT
   ...
   // BUTTON FUNCTION FOR ADDING PRODUCT TO BILLING TABLE
   ...
   $('#add').on('click', function () {
      ...
      function billFunction() {
         ...
         $("#receipt_bill").each(function () {
          ...
          // AJAX FUNCTION FOR CREATING ROWS IN BILLING TABLE 
            ...
            // SETTING RESPONSE DATA TO ITS CORRESPONDING COMPONENT
   ...
   $("#createorder").click(function () {
      ...
      // CREATING ARRAY OF PRODUCTS TO SAVE IN DATABASE
            ...
            // AJAX REQUEST FOR CREATING ORDER FOR CUSTOMER
            ...
            $.ajax({
               ...
               success: function (data) {
                  ...
                  //  CLEARING ALL VALUES AFTER SUCCESS
